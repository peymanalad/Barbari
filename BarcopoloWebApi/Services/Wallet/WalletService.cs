...
namespace BarcopoloWebApi.Services.Wallet
{
    public class WalletService : IWalletService
    {
        ...
        private async Task<bool> CanChargeWallet(global::Wallet wallet, Entities.Person user)
        {
            if (wallet.OwnerType == WalletOwnerType.Person)
        ...
        private async Task<bool> HasAccessToWallet(global::Wallet wallet, long currentUserId)
        {
            var user = await _context.Persons.FindAsync(currentUserId);
